...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
    {
      question: "Console.log(3>2>1); Output of the code will be ?",  ///// Write the question inside double quotes
      answers: {
    ...
    {
      question: "const isTrue = true == ![];  const isFalse = false == []; console.log(isTrue + isFalse);",  ///// Write the question inside double quotes
      answers: {
